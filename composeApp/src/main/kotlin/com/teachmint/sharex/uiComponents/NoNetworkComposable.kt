...
fun NoNetworkComposable(
    ...
    val title = stringResource(R.string.no_network_title)
    val subtitle = stringResource(R.string.no_network_subtitle)
    ...
    Column(
        ...
        Image(
            ...
            painter = painterResource(R.drawable.satellite_icon_no_padding),
