...
actual class HostSignalingServer actual constructor(
    ...
    actual val connectedClients: SharedFlow<List<ClientInfo>> = _connectedClients.asStateFlow()

    private var engine: EmbeddedServer<*, *>? = null
    private var activePort: Int? = null

    actual suspend fun start(port: Int): Int {
    ...
    actual suspend fun send(clientId: String, message: SignalingMessage) {
