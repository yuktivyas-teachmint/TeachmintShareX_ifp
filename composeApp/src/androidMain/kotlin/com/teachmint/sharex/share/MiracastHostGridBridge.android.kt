...
@Composable
actual fun rememberMiracastActiveShare(): ActiveShare? {
...
@Composable
actual fun rememberMiracastConnectedClients(): List<ClientInfo> {
    val playbackState by MiracastPlaybackManager.state.collectAsState()
...
@Composable
actual fun rememberMiracastClientPolicies(): Map<String, ClientCastingPolicy> {
    val playbackState by MiracastPlaybackManager.state.collectAsState()
...
actual fun setMiracastClientAudioMuted(clientId: String, muted: Boolean) {
    MiracastPlaybackManager.setAudioMuted(muted)
}

actual fun disconnectMiracastClient(clientId: String) {
    MiracastPlaybackManager.stopSession()
}

@Composable
actual fun MiracastTileRenderer(
    share: ActiveShare,
    modifier: Modifier,
) {
    val playbackState by MiracastPlaybackManager.state.collectAsState()
