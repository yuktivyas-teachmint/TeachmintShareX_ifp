...
actual fun createHostController(
...
actual fun generateClientId(): String = UUID.randomUUID().toString()

actual fun getPlatformName(): String = "Android ${Build.MODEL}".trim()

actual fun getSavedDeviceName(): String? {
...
actual fun getHostDisplayName(): String {
...
actual fun getConnectedWifiName(): String? {
    val context = AndroidContextHolder.applicationContext ?: return null
...
actual fun isSecureOrigin(): Boolean = false

actual fun isScreenCaptureSupported(): Boolean = true

actual fun currentTimeMillis(): Long = System.currentTimeMillis()

actual fun secureRandomInt(bound: Int): Int = java.security.SecureRandom().nextInt(bound)
