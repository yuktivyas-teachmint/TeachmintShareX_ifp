        ...
        Card(
            ...
            Column(
                ...
                Column(
                    ...
                    Text(
                        text = "ShareX uses Android's Accessibility Service to allow a remote teacher or presenter to perform gestures (tap, scroll, swipe) on this device during an active ShareX screen-sharing session.",
                    ...
                    Text(
                        text = "This service is only active while a remote control session is in progress. It does not collect, store, or transmit any personal data and cannot be used outside of an active session.\n\nYou will be redirected to Accessibility Settings to enable this permission.",
