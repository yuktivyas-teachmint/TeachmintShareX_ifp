        ...
        Card(
            ...
            Column(
                ...
                Column(
                    ...
                    Text(
                        text = "$clientName is requesting access to this board's camera and microphone for their video meeting.",
                    ...
                    Text(
                        text = "This will stream the board's camera and microphone to their device so they can use it in Zoom, Teams, or Google Meet. The stream is only active during the session and is not recorded or stored on this board.",
